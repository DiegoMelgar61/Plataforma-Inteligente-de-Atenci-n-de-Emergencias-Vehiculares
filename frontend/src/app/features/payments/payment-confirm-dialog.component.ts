        ...
        <div class="flex items-center justify-between px-6 py-4 flex-shrink-0"
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xs font-mono" style="color: var(--text-muted);">#{{ payment.id_pago }}</p>
            </div>
          </div>
        ...
        <div class="overflow-y-auto flex-1 px-6 py-4 space-y-4">
          ...
          <div class="rounded-xl p-4 space-y-3" style="background: var(--bg-elevated); border: 1px solid var(--border);">
            <div class="flex items-center justify-between text-sm">
              ...
              <span class="font-mono font-semibold" style="color: var(--text-primary);">#{{ payment.id_incidente }}</span>
            </div>
            <div class="flex items-center justify-between text-sm">
